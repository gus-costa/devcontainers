...
# Build from images/ directory as per specs/publishing.md
devcontainer build --image-name ${id_image} --workspace-folder "images/${IMAGE}/"
echo "(*) Starting container - ${IMAGE}"
devcontainer up --id-label ${id_label} --workspace-folder "images/${IMAGE}/"
